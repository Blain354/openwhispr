...
| Microsoft Teams                                                                                                | "Markdown-style" dialect with single-asterisk bold, rendered as a live preview while typing; vendor and community tests report paste is not parsed (support.microsoft.com use-markdown-formatting). Not yet pasted-tested here; the Slack result makes the same outcome likely.                                                                                       |
